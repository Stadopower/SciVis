    ...
    for(int i = 0; i <numberOfColors; i++){
        if(t != 0){
            newTurboColorMap.push_back({(fullTurboColorMap[i*stepSize].r+ t * ((fullTurboColorMap[i*stepSize+1].r) - fullTurboColorMap[i*stepSize].r)),
                                        (fullTurboColorMap[i*stepSize].g+ t * ((fullTurboColorMap[i*stepSize+1].g) - fullTurboColorMap[i*stepSize].g)),
                                        (fullTurboColorMap[i*stepSize].b+ t * ((fullTurboColorMap[i*stepSize+1].b) - fullTurboColorMap[i*stepSize].b))});
        }else{
            newTurboColorMap.push_back(fullTurboColorMap[stepSize*i]);
        }
    }

    return newTurboColorMap;
}
...
std::vector<Color> Texture::createBlueYellowTexture(size_t const numberOfColors)
{
    Color const blue{0.0F, 0.0F, 0.9F};
    Color const white{0.6F, 0.6F, 0.6F};
    Color const yellow{0.9F, 0.9F, 0.0F};
